...
public class MainActivity extends AppCompatActivity implements ForecastAdapter.ForecastAdapaterOnClickHandler {
    ...
    //Override to allow handling of RecylerView Clicks
    @Override
