...
public class ForecastAdapter extends RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> {
    ...
    private final ForecastAdapaterOnClickHandler mClickHandler;
    ...
    public interface ForecastAdapaterOnClickHandler{
        void onClick(String weatherForDay);
    }

    // TODO (4) Add a ForecastAdapterOnClickHandler as a parameter to the constructor and store it in mClickHandler
    public ForecastAdapter(ForecastAdapaterOnClickHandler clickHandler) {
    ...
    public class ForecastAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            /* sets weatherForDay to adapter position that was clicked and uses that position to
            pull from mWeatherData[Array]
             */
